...
class ModuleRollbackCompatibilityTest extends TestCase
{
    ...
    public function test_the_source_controlled_runtime_manifest_represents_the_current_release(): void
    {
        ...
        $this->assertSame('0.27.2', trim((string) file_get_contents(base_path('VERSION'))));
        $this->assertSame('0.27.2', $manifest['application_version']);
        $this->assertSame([
            'apes-cic:cases',
            'apes-cic:tickets',
        ...
        $this->assertSame('0.27.2', $result['target_version']);
    }
