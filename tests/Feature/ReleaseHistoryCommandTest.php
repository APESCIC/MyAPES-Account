...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-11', $releases[20]['date']);
        ...
        $this->assertSame('2026-08-08', $releases[27]['date']);
        $this->assertSame('2026-08-07', $releases[28]['date']);
        $this->assertSame('2026-08-06', $releases[29]['date']);
        ...
        $this->assertSame('2026-07-28', $releases[33]['date']);
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #87',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/87',
                ],
                [
                    'label' => 'Pull request #88',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/88',
                ],
            ],
            $current['references'],
        );
