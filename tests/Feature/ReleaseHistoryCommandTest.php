...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-23', $releases[9]['date']);
        ...
        $this->assertSame('2026-08-11', $releases[29]['date']);
        ...
        $this->assertSame('2026-08-08', $releases[36]['date']);
        $this->assertSame('2026-08-07', $releases[37]['date']);
        $this->assertSame('2026-08-06', $releases[38]['date']);
        ...
        $this->assertSame('2026-07-28', $releases[42]['date']);
    ...
    public function test_validation_command_accepts_the_bootstrap_history(): void
    {
        $this->artisan('myapes:changelog-validate')
            ->expectsOutputToContain('Release history is valid at v0.25.6')
            ->assertSuccessful();
    }
