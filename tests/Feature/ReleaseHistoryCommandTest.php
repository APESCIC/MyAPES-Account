    ...
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #103',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/103',
                ],
                [
                    'label' => 'Pull request #115',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/115',
                ],
            ],
            $current['references'],
        );
