...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        foreach (array_slice($releases, 50) as $release) {
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #96',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/96',
                ],
                [
                    'label' => 'Pull request #119',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/119',
                ],
            ],
            $current['references'],
        );
