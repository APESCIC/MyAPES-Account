...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-23', $releases[7]['date']);
        $this->assertSame('2026-08-22', $releases[8]['date']);
        $this->assertSame('2026-08-22', $releases[9]['date']);
        $this->assertSame('2026-08-22', $releases[10]['date']);
        ...
        $this->assertSame('2026-08-14', $releases[26]['date']);
        $this->assertSame('2026-08-11', $releases[27]['date']);
        $this->assertSame('2026-08-10', $releases[28]['date']);
        $this->assertSame('2026-08-10', $releases[29]['date']);
        $this->assertSame('2026-08-10', $releases[30]['date']);
        $this->assertSame('2026-08-09', $releases[31]['date']);
        $this->assertSame('2026-08-09', $releases[32]['date']);
        $this->assertSame('2026-08-09', $releases[33]['date']);
        $this->assertSame('2026-08-08', $releases[34]['date']);
        $this->assertSame('2026-08-07', $releases[35]['date']);
        $this->assertSame('2026-08-06', $releases[36]['date']);
        $this->assertSame('2026-08-05', $releases[37]['date']);
        $this->assertSame('2026-08-05', $releases[38]['date']);
        $this->assertSame('2026-08-05', $releases[39]['date']);
        $this->assertSame('2026-07-28', $releases[40]['date']);
        ...
        foreach (array_slice($releases, 45) as $release) {
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #111',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/111',
                ],
                [
                    'label' => 'Issue #108',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/108',
                ],
                [
                    'label' => 'Pull request #112',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/112',
                ],
            ],
            $current['references'],
        );
    ...
    public function test_validation_command_accepts_the_bootstrap_history(): void
    {
        $this->artisan('myapes:changelog-validate')
            ->expectsOutputToContain('Release history is valid at v0.25.4')
            ->assertSuccessful();
    }
