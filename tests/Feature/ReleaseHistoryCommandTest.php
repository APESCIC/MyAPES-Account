...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-23', $releases[12]['date']);
        ...
        $this->assertSame('2026-08-14', $releases[30]['date']);
        $this->assertSame('2026-08-14', $releases[31]['date']);
        $this->assertSame('2026-08-11', $releases[32]['date']);
        ...
        $this->assertSame('2026-08-08', $releases[39]['date']);
        $this->assertSame('2026-08-07', $releases[40]['date']);
        $this->assertSame('2026-08-06', $releases[41]['date']);
        ...
        $this->assertSame('2026-07-28', $releases[45]['date']);
        ...
        foreach (array_slice($releases, 49) as $release) {
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #95',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/95',
                ],
                [
                    'label' => 'Pull request #118',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/118',
                ],
            ],
            $current['references'],
        );
    ...
    public function test_validation_command_accepts_the_bootstrap_history(): void
    {
        $this->artisan('myapes:changelog-validate')
            ->expectsOutputToContain('Release history is valid at v0.25.9')
            ->assertSuccessful();
    }
