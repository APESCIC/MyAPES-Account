...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-23', $releases[11]['date']);
        ...
        $this->assertSame('2026-08-11', $releases[31]['date']);
        ...
        $this->assertSame('2026-08-08', $releases[38]['date']);
        $this->assertSame('2026-08-07', $releases[39]['date']);
        $this->assertSame('2026-08-06', $releases[40]['date']);
        ...
        $this->assertSame('2026-07-28', $releases[44]['date']);
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #94',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/94',
                ],
                [
                    'label' => 'Pull request #117',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/117',
                ],
            ],
            $current['references'],
        );
    ...
    public function test_validation_command_accepts_the_bootstrap_history(): void
    {
        $this->artisan('myapes:changelog-validate')
            ->expectsOutputToContain('Release history is valid at v0.25.8')
            ->assertSuccessful();
    }
