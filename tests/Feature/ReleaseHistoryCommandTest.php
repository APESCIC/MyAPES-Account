...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-14', $releases[14]['date']);
        $this->assertSame('2026-08-14', $releases[15]['date']);
        $this->assertSame('2026-08-11', $releases[16]['date']);
        $this->assertSame('2026-08-10', $releases[17]['date']);
        $this->assertSame('2026-08-10', $releases[18]['date']);
        $this->assertSame('2026-08-10', $releases[19]['date']);
        $this->assertSame('2026-08-09', $releases[20]['date']);
        $this->assertSame('2026-08-09', $releases[21]['date']);
        $this->assertSame('2026-08-09', $releases[22]['date']);
        $this->assertSame('2026-08-08', $releases[23]['date']);
        $this->assertSame('2026-08-07', $releases[24]['date']);
        $this->assertSame('2026-08-06', $releases[25]['date']);
        $this->assertSame('2026-08-05', $releases[26]['date']);
        $this->assertSame('2026-08-05', $releases[27]['date']);
        $this->assertSame('2026-08-05', $releases[28]['date']);
        $this->assertSame('2026-07-28', $releases[29]['date']);
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #78',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/78',
                ],
                [
                    'label' => 'Pull request #79',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/79',
                ],
            ],
            $current['references'],
        );
