...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-23', $releases[3]['date']);
        ...
        $this->assertSame('2026-08-11', $releases[23]['date']);
        ...
        $this->assertSame('2026-08-08', $releases[30]['date']);
        $this->assertSame('2026-08-07', $releases[31]['date']);
        $this->assertSame('2026-08-06', $releases[32]['date']);
        ...
        $this->assertSame('2026-07-28', $releases[36]['date']);
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #101',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/101',
                ],
            ],
            $current['references'],
        );
    ...
    public function test_validation_command_accepts_the_bootstrap_history(): void
    {
        $this->artisan('myapes:changelog-validate')
            ->expectsOutputToContain('Release history is valid at v0.25.0')
            ->assertSuccessful();
    }
