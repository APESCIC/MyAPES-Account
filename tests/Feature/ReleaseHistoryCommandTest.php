...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('2026-08-23', $releases[8]['date']);
        ...
        $this->assertSame('2026-08-14', $releases[27]['date']);
        $this->assertSame('2026-08-11', $releases[28]['date']);
        ...
        $this->assertSame('2026-08-08', $releases[35]['date']);
        $this->assertSame('2026-08-07', $releases[36]['date']);
        $this->assertSame('2026-08-06', $releases[37]['date']);
        ...
        $this->assertSame('2026-07-28', $releases[41]['date']);
        ...
        foreach (array_slice($releases, 46) as $release) {
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #113',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/113',
                ],
                [
                    'label' => 'Issue #108',
                ...
                [
                    'label' => 'Pull request #114',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/114',
                ],
            ],
            $current['references'],
        );
    ...
    public function test_validation_command_accepts_the_bootstrap_history(): void
    {
        $this->artisan('myapes:changelog-validate')
            ->expectsOutputToContain('Release history is valid at v0.25.5')
            ->assertSuccessful();
    }
