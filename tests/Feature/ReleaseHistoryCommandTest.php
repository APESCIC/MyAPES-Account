...
class ReleaseHistoryCommandTest extends TestCase
{
    public function test_source_controlled_history_contains_the_required_release_sequence(): void
    {
        ...
        $this->assertSame('0.27.0', $repository->version());
        $this->assertSame('0.27.0', $repository->current()['version']);
        $this->assertSame(
        ...
        $this->assertSame('2026-08-23', $releases[15]['date']);
        $this->assertSame('2026-08-22', $releases[16]['date']);
        ...
        $this->assertSame('2026-08-19', $releases[29]['date']);
        ...
        $this->assertSame('2026-08-14', $releases[33]['date']);
        $this->assertSame('2026-08-14', $releases[34]['date']);
        $this->assertSame('2026-08-11', $releases[35]['date']);
        $this->assertSame('2026-08-10', $releases[36]['date']);
        $this->assertSame('2026-08-10', $releases[37]['date']);
        $this->assertSame('2026-08-10', $releases[38]['date']);
        $this->assertSame('2026-08-09', $releases[39]['date']);
        $this->assertSame('2026-08-09', $releases[40]['date']);
        $this->assertSame('2026-08-09', $releases[41]['date']);
        $this->assertSame('2026-08-08', $releases[42]['date']);
        $this->assertSame('2026-08-07', $releases[43]['date']);
        $this->assertSame('2026-08-06', $releases[44]['date']);
        $this->assertSame('2026-08-05', $releases[45]['date']);
        $this->assertSame('2026-08-05', $releases[46]['date']);
        $this->assertSame('2026-08-05', $releases[47]['date']);
        $this->assertSame('2026-07-28', $releases[48]['date']);
        $this->assertSame('2026-07-27', $releases[49]['date']);
        ...
        foreach (array_slice($releases, 52) as $release) {
        ...
        $this->assertSame(
            [
                [
                    'label' => 'Issue #97',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/issues/97',
                ],
                [
                    'label' => 'Pull request #120',
                    'url' => 'https://github.com/APESCIC/MyAPES-Account/pull/120',
                ],
            ],
            $current['references'],
        );
    ...
    public function test_validation_command_accepts_the_bootstrap_history(): void
    {
        $this->artisan('myapes:changelog-validate')
            ->expectsOutputToContain('Release history is valid at v0.26.1')
            ->assertSuccessful();
    }
