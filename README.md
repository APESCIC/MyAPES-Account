...
- **Administration**:
  ...
  - Admin Groups shows managed Cloudron `myapesaccount.*` directory groups, aggregate counts, and synchronization status. Super-admins can request asynchronous synchronization and attach or remove optional job-role mappings. Enable/disable and protected-mapping edits stay unavailable.
